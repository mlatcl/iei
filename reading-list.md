...
reading:
  ...
  - title: "Elements of Information Theory"
    ...
    required: true
    estimated_hours: 8
    notes: "A complement to MacKay. Chapters 2, 7, and 12 most relevant (entropy, channel capacity, maximum entropy). Theorem 2.8.1 is the data-processing inequality: stated week 3, proved week 8. Weeks 3, 5, and 8."
  ...
  - title: "Probability Theory: The Logic of Science"
    ...
    required: true
    estimated_hours: 6
    notes: "Chapters 11-12 on maximum entropy inference. Primary source for the Bayesian perspective in LO5-LO7. Week 5."
  ...
  - title: "Information Geometry and Its Applications"
    ...
    required: true
    estimated_hours: 6
    notes: "Chapters 1-4 cover the Fisher metric, dually flat geometry, and exponential families. Primary text for weeks 6-7 (LO8, LO9)."
  ...
  - title: "The Atomic Human"
    ...
    required: false
    estimated_hours: 3
    notes: "Chapter 1 for the embodiment factor and the human–machine bandwidth gap (~100 bit/s versus gigabits). Week 1 motivation; week 4 with Landauer; week 8 as a named no-go."
  ...
  - title: "Quantum Computation and Quantum Information"
    ...
    required: false
    estimated_hours: 3
    notes: "Chapter 11 (quantum information theory) for von Neumann entropy and the passage from classical to quantum probability. Week 8 (LO11)."
  ...
  - title: "Generative AI and Stochastic Thermodynamics: A Tale of Free Energies"
    ...
    required: false
    estimated_hours: 3
    notes: "Supplementary. Draft on the course site. Ch. 3 for Boltzmann, free energy, Maxwell/Landauer (weeks 1–4); §1.5.5 and Ch. 5 for MaxEnt and the ELBO (week 5); Ch. 14 and §§22.2–22.3 for the Schrödinger bridge, Wasserstein, and finite-time Landauer (week 8). The Crooks in this book is the 1999 fluctuation theorem (Ch. 17), not thermodynamic length. The speed limit in Ch. 22 is W₂²/(Tτ), not L²/τ. Does not cover Amari, multi-information, or von Neumann entropy."
  ...
  - title: "Information Engines (seminar notes)"
    ...
    required: false
    estimated_hours: 1
    notes: "Optional. Jaynes' world, unified intelligence perspective, car-engine vs ATP synthase scale argument in full. Week 4 (LO4) and week 8 bridge."
  ...
  - title: "Thermodynamics of information"
    ...
    required: false
    estimated_hours: 1
    notes: "Modern review: Szilárd engine, feedback second law $W \ge -k_B T I(X;M)$, memories, Landauer, experiments. Week 4 (LO4)."
  ...
  - title: "Feynman Lectures on Computation"
    ...
    required: false
    estimated_hours: 0.5
    notes: "Chapter 5: reversible computation, Szilard engine, known microstate as fuel. Complement with Feynman Lectures Vol. I, Ch. 46 (ratchet). Week 4 (LO4)."
  ...
  - title: "Irreversibility and Heat Generation in the Computing Process"
    ...
    required: true
    estimated_hours: 1
    notes: "The two-page original paper establishing Landauer's principle. Should be read directly. Week 4 (LO4)."
  ...
  - title: "The Thermodynamics of Computation — A Review"
    ...
    required: false
    estimated_hours: 1
    notes: "Szilard engine, Maxwell's demon resolution, logical irreversibility of erasure (phase-space compression). Non-circular counterpart to Ellis's circularity charge. Worksheet 2 Part B (ii); optional with Landauer (1961). Week 4 (LO4)."
  ...
  - title: "Information Theory and Statistical Mechanics"
    ...
    required: true
    estimated_hours: 1
    notes: "The original maximum entropy paper. Very readable. Week 5 (LO5)."
  ...
  - title: "A Mathematical Theory of Communication"
    ...
    required: false
    estimated_hours: 2
    notes: "Sections 1-6 give the clearest original exposition of the entropy axioms. Week 3 (LO2)."
  ...
  - title: "Measuring Thermodynamic Length"
    ...
    required: true
    estimated_hours: 1
    notes: "Identifies thermodynamic length with Fisher–Rao length of a path of equilibrium states; dissipation bound L²/τ. Week 6 define (LO8); week 8 interpret (LO12)."
  ...
  - title: "Sinkhorn Distances: Lightspeed Computation of Optimal Transportation Distances"
    ...
    required: false
    estimated_hours: 1
    notes: "The ML paper that named Sinkhorn distances and showed entropic regularization of OT enables lightspeed computation. §§3–4: the MaxEnt perspective (entropic constraint = I(X;Y) ≤ α) and the Sinkhorn-Knopp iteration. Connects to week 8 via mutual information. Week 8, optional (LO12)."
  ...
  - title: "Information Theoretical Analysis of Multivariate Correlation"
    ...
    required: false
    estimated_hours: 1
    notes: "Defines multi-information (total correlation). Week 8 (LO10)."
  ...
  - title: "The Information Bottleneck Method"
    ...
    required: false
    estimated_hours: 1
    notes: "Optional. Least-committal representation T of X that keeps I(T;Y). The prescription inside the data-processing inequality. Week 8 (LO10)."
  ...
  - title: "Information Theory and Statistical Mechanics"
    ...
    required: false
    estimated_hours: 1
    notes: "Brandeis lectures: MaxEnt for density matrices and von Neumann entropy. Week 8 (LO11)."
---
...
Chapters 1–4 for entropy; Chapters 8–10 for dependent variables and the noisy channel; Chapter 22 for maximum entropy. The primary accessible reference for weeks 3 and 5.

**Cover & Thomas (2006)** — *Elements of Information Theory* (2nd ed.)
The rigorous complement to MacKay. Chapter 2 (entropy), Chapter 7 (channel capacity), Chapter 12 (maximum entropy). Theorem 2.8.1 is the data-processing inequality: stated in week 3, proved in week 8. Weeks 3, 5, and 8.

**Jaynes (2003)** — *Probability Theory: The Logic of Science* ([free online](https://bayes.wustl.edu/etj/prob/book.pdf))
Chapters 11–12 on maximum entropy. The primary source for the Bayesian perspective (LO5–LO7). Week 5.

**Amari (2016)** — *Information Geometry and Its Applications*
Chapters 1–4 for the Fisher metric, dually flat geometry, and exponential families. Primary text for weeks 6–7.
...
|-------|------|----------------|
| 1–2 | Ch. 3 (ensembles, $F=U-TS$, heat as $\delta\rho$, work as $\delta H$) | Perpetual motion; Shannon axioms; channel capacity |
| 3 | §1.2.3–1.2.4 (entropy, KL) | Shannon axioms as a substitute for MacKay/Cover |
| 4 | §3.3, pp. 49–52 (Maxwell, Landauer, Bennett); optional Parrondo et al. (2015); Ellis excerpt (Worksheet 2) | Szilard's engine calculation; full fluctuation-theorem formalism |
| 5 | §1.5.5 (MaxEnt $\to$ canonical); Ch. 5 (ELBO as nonequilibrium free energy) | The three-perspective comparison. GAIST collapses thermo and ML; we do not. |
| 6–7 | Nothing required. Ch. 17 is the *other* Crooks (1999 fluctuation theorem). | Thermodynamic length; Fisher–Rao; Amari; natural gradient. The speed limit in Ch. 22 is Wasserstein. |
| 8 | — | Multi-information; $I+H=C$; DPI; information bottleneck; von Neumann entropy |
...
Two pages; should be read in full. Week 4 (LO4).
...
Accessible review of Szilárd's engine, the feedback second law, physical memories, laboratory realizations, and molecular-scale engines. Week 4 (LO4).
...
Optional depth: Jaynes' world, car-engine versus ATP synthase scale contrast, unified intelligence perspective. Week 4 and week 8 bridge; full synthesis week 8.

**Feynman & Hey (1996)** — *Feynman Lectures on Computation*
Chapter 5 on reversible computation and the Szilard engine; known microstate as thermodynamic fuel. Pair with *The Feynman Lectures on Physics* Vol. I, Ch. 46 (ratchet and one-bath caution). Week 4 (LO4).

**Jaynes (1957)** — "Information Theory and Statistical Mechanics," *Phys. Rev.* 106, 620.
The original maximum entropy paper; very readable. Week 5 (LO5).

**Shannon (1948)** — "A Mathematical Theory of Communication," *Bell Syst. Tech. J.*
Sections 1–6 for the entropy axioms. Week 3 (LO2).

**Crooks (2007)** — "Measuring Thermodynamic Length," *Phys. Rev. Lett.* 99, 100602.
Thermodynamic length as Fisher–Rao length; dissipation $\ge \mathcal{L}^2/\tau$. Define in week 6 (LO8); interpret in week 8 (LO12).

**Watanabe (1960)** — "Information Theoretical Analysis of Multivariate Correlation," *IBM J. Res. Dev.*
The original multi-information paper. Week 8 (LO10).
...
Optional. The variational problem $\min I(X;T)-\beta I(T;Y)$: keep relevance, discard the rest. Week 8 (LO10); used later in the same session.

**Jaynes (1963)** — "Information Theory and Statistical Mechanics," Brandeis lectures.
MaxEnt applied to density matrices. Week 8 (LO11).
